            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                    <div class="flex items-start justify-between mb-4">
                        ...
                        <span
                            class="text-xs font-medium text-green-600 bg-green-50 px-2 py-1 rounded-full">+15.3%</span>
                    </div>
                ...
                <div class="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                    <div class="flex items-start justify-between mb-4">
                        ...
                        <span class="text-xs font-medium text-gray-600 bg-gray-50 px-2 py-1 rounded-full">156
                            active</span>
                    </div>
                ...
                <div class="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                    <div class="flex items-start justify-between mb-4">
                        ...
                        <span class="text-xs font-medium text-green-600 bg-green-50 px-2 py-1 rounded-full">+234
                            new</span>
                    </div>
                ...
                <div class="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-lg transition-shadow">
                    <div class="flex items-start justify-between mb-4">
                        ...
                        <span
                            class="text-xs font-medium text-orange-600 bg-orange-50 px-2 py-1 rounded-full">Alert</span>
                    </div>
                        ...
                        <table class="w-full">
                            ...
                            <tbody>
                                <tr class="border-t border-gray-100 hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="py-4 px-6">
                                        <span
                                            class="text-xs font-medium px-3 py-1 rounded-full bg-green-100 text-green-700">Completed</span>
                                    </td>
                                </tr>
                                <tr class="border-t border-gray-100 hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="py-4 px-6">
                                        <span
                                            class="text-xs font-medium px-3 py-1 rounded-full bg-yellow-100 text-yellow-700">Pending</span>
                                    </td>
                                </tr>
                                <tr class="border-t border-gray-100 hover:bg-gray-50 transition-colors">
                                ...
                                <tr class="border-t border-gray-100 hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="py-4 px-6">
                                        <span
                                            class="text-xs font-medium px-3 py-1 rounded-full bg-blue-100 text-blue-700">Processing</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="bg-white rounded-xl border border-gray-200">
                    ...
                    <div class="p-6 space-y-4">
                        <div
                            ...
                            <div
                                class="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-500 rounded-lg flex items-center justify-center text-white font-bold text-sm">
                                #1
                            </div>
                        ...
                        <div
                            class="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
                            <div
                                class="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-500 rounded-lg flex items-center justify-center text-white font-bold text-sm">
                                #2
                            </div>
                            <div class="flex-1 min-w-0">
                        ...
                        <div
                            class="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
                            <div
                                class="w-10 h-10 bg-gradient-to-br from-orange-500 to-red-500 rounded-lg flex items-center justify-center text-white font-bold text-sm">
                                #3
                            </div>
                            <div class="flex-1 min-w-0">
                        ...
                        <div
                            class="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
                            <div
                                class="w-10 h-10 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-lg flex items-center justify-center text-white font-bold text-sm">
                                #4
                            </div>
                            <div class="flex-1 min-w-0">
