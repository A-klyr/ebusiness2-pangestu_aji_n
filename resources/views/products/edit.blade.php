    ...
    <div x-data="{ sidebarOpen: true, activeMenu: 'products', imagePreview: '{{ $product->image ? Storage::url($product->image) : null }}' }" class="flex h-screen bg-gray-50">
        ...
        <div :class="sidebarOpen ? 'w-64' : 'w-20'" class="bg-white border-r border-gray-200 transition-all duration-300 flex flex-col">
            ...
            <nav class="flex-1 py-4">
                ...
                <a href="{{ route('admin.products.index') }}" class="w-full flex items-center gap-3 px-4 py-3 bg-blue-50 text-blue-600 border-r-4 border-blue-600 transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 overflow-auto">
            ...
            <!-- Form Content -->
            <div class="p-6">
                <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="max-w-4xl mx-auto">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
                        ...
                        <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-200">
                            <a href="{{ route('admin.products.index') }}" class="px-6 py-2 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors font-medium">
                                Cancel
                            </a>
