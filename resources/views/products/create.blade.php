<x-admin-layout>
    ...
    <div x-data="{ sidebarOpen: true, activeMenu: 'products', imagePreview: null }" class="flex h-screen bg-gray-50">
        <!-- Sidebar (simplified - sama seperti index) -->
        ...
        <div class="flex-1 overflow-auto">
            ...
            <!-- Form Content -->
            <div class="p-6">
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="max-w-4xl mx-auto">
                    @csrf
